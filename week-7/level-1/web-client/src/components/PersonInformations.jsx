...
const PersonInformations = () => {
  const { personList, getPersonList, sendEmail } = useContext(UserContext);
  ...
  const handleSendMail = () => {
    sendEmail({ maritalStatus: status });
  };
  ...
  return (
    <div className="col-lg-8">
      ...
      <button onClick={handleSendMail} className="btn btn-success mb-1 ms-5">
        Send reminder email
      </button>

    ...
    <div className="col-lg-3">
      ...
      <form onSubmit={handleSubmit} className="border border-1 p-3 bg-secondary rounded mt-5">
        ...
        <div className="mb-3">
          ...
          <input type="number" value={age} onChange={(e) => setAge(e.target.value)} className="form-control" id="exampleFormControlInput3" placeholder="Age" />
        </div>
        <div className="mb-3">
